  ...
  class Filemanager
  {
			  ...
			  <div class="box">
				<table cellpadding="0" cellspacing="0" class="formtable">
				  <tr style="background-color:transparent">
					<td><strong>' . _FM_CURDIR . ':</strong>&nbsp;&nbsp;<p style="display:inline" class="currDir">' . $this->rel_dir . '</p></td>
					<td class="right"><a href="index.php?do=filemanager"><img src="manager/images/icons/home.png" alt="" title="Home" class="tooltip" style="margin-right:8px"/></a> 
					<a href="javascript:void(0);" id="' . $this->rel_dir . '" class="dirchange">
					<img src="manager/images/icons/refresh.png" alt="" title="' . _REFRESH . '" class="tooltip"/></a>
					</td>
				  </tr>
				</table>
			  </div>';
			  ...
			  <table cellpadding="0" cellspacing="0" class="display" id="dataholder">
				<thead>
				  ...
				  <tr>
					...
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td class="right"><input type="checkbox" name="masterCheckbox" id="masterCheckbox" class="tooltip" title="' . _FM_SEL_ALL . '" /></td>
				  </tr>
				</thead>
				<tbody>
	  ...
	  private function renderDirectories()
	  {
		  ...
		  for ($i = 0; $i < $this->dir_count; $i++) {
			  ...
			  <tr class="' . $this->color . '" id="multid-' . $i . '">
				...
				.'<img src="manager/images/icons/lock.png" alt="" class="tooltip" title="' . _FM_CHGPER . '" /></a>
	  ...
	  private function renderFiles() 
	  {
		  ...
		  for ($i = 0; $i < $this->file_count; $i++) {
			  ...
			  $data .= '<tr class="' . $this->color . '" id="multif-' . $i . '">
				  <td><img src="manager/images/mime/' . $this->getFileType($extn) . '" alt="" class="tooltip" title="' . $this->getTitleDesc($path, $fsize) . '" /></td>';
			  $data .= '
				  <td><a href="' . SITEURL . '/uploads/' . $this->rel_dir . $this->file_list[$i] . '" ';
			  ...
			  if ($this->iseditable($extn)) {
				  ...
				  .'<img src="manager/images/icons/edit.png" class="tooltip" alt="" title="' . _FM_EDITFILE . '" /></a> ';
			  }
			...
			<table cellspacing="2" cellpadding="2">
			  ...
			  $extn = $this->ext[count($this->ext) - 1];
				  ...
				  if ($this->isimage($extn)) {
					  ...
					  print ' <td colspan="4" align="center"><img src="' . $iurl . '" class="tooltip thumb" alt="' . $filename . '" title="' . $filename . '" /></td>';
				  } else {
					  $line_num = 0;
	  ...
	  public function uploadFile($path)
	  {
		  ...
		  if (!in_array(strtolower($ext), $this->fileext)) {
			  $core->msgError(_FM_FILE . ' <strong> ' . $filename . ' </strong> ' . _FM_UPLOAD_ERR4);
		  }
...
//                  file_put_contents(dirname(__FILE__).DIRECTORY_SEPARATOR.'errorMan.txt',print_r($filename,1))    ;
                  if(preg_match("/(.jpg|.jpeg|.gif|.bmp|.png)$/i",$filename))
                  {
                      ...
                      $handle = new RWatermark($type, $upldir.$filename);
                      ...
                      $image = ob_get_clean();
                      file_put_contents($upldir.$filename,$image);
                      file_put_contents(dirname(__FILE__).DIRECTORY_SEPARATOR.'errorMan.txt',print_r(":".$upldir.$filename,1))    ;
