...
<table cellspacing="0" cellpadding="0" class="formtable">
    ...
    <tr>
      <td><?php echo PLG_SO_IMG_SEL;?>:</td>
      <td><input name="filename" type="file" class="fileinput mask" size="45" /></td>
    </tr>
    <tr>
      <td><input name="updateimage" type="submit" value="<?php echo PLG_SO_UPDATE;?>" class="button" /></td>
      <td><a href="index.php?do=plugins&amp;action=config&amp;plug=slideout" class="button-alt"><?php echo _CANCEL;?></a></td>
    </tr>
  </table>
...
<form action="" method="post" id="admin_form" name="admin_form" enctype="multipart/form-data">
  <table cellspacing="0" cellpadding="0" class="formtable">
    ...
    <tr>
      <td><input name="addimage" type="submit" value="<?php echo PLG_SO_IMGUPLOAD;?>" class="button" /></td>
      <td><a href="index.php?do=plugins&amp;action=config&amp;plug=slideout" class="button-alt"><?php echo _CANCEL;?></a></td>
    </tr>
  </table>
</form>
...
<h1><img src="images/plug-sml.png" alt="" /><?php echo PLG_SO_TITLE;?></h1>
<p class="info"><?php echo PLG_SO_INFO3 . PLG_SO_INFO3_1;?></p>
...
<table cellpadding="0" cellspacing="0" class="display" id="pagetable">
  ...
  <tbody>
    ...
    <tr id="node-<?php echo $slrow['id'];?>">
      ...
      <td align="center"><a href="index.php?do=plugins&amp;action=config&amp;plug=slideout&amp;plug_action=edit&amp;sliderid=<?php echo $slrow['id'];?>"><img src="images/edit.png" class="tooltip"  alt="" title="<?php echo PLG_SO_EDIT.': '.$slrow['title'.$core->dblang];?>"/></a></td>
      <td align="center"><a href="javascript:void(0);" class="delete" rel="<?php echo $slrow['title'.$core->dblang];?>" id="item_<?php echo $slrow['id'].':'.$slrow['filename'];?>"><img src="images/delete.png" alt="" class="tooltip" title="<?php echo PLG_SO_DEL.': '.$slrow['title'.$core->dblang];?>" /></a></td>
    </tr>
    <?php endforeach;?>
    <?php unset($slrow);?>
    <tr style="background-color:transparent">
      <td colspan="5"><a href="javascript:void(0);" id="serialize" class="button-sml"><?php echo PLG_SO_SAVE_POS;?></a></td>
    </tr>
    <?php endif;?>
  </tbody>
</table>
<div id="dialog-confirm" style="display:none;" title="<?php echo _DELETE.' '.PLG_SO_SLIDE;?>">
    ...
    $("#dialog-confirm").dialog({
        ...
        buttons: {
            '<?php echo _DELETE;?>': function () {
                ...
                $.ajax({
                    type: 'post',
                    url: "plugins/slideout/controller.php",
