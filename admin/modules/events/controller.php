...
<?php
  ...
  print ($db->affected()) ? $hollysec->writeLog(PLG_EM_EVENT .' <strong>'.$title.'</strong> '._DELETED, "", "no", "module") . $core->msgOk(PLG_EM_EVENT .' <strong>'.$title.'</strong> '._DELETED) : $core->msgAlert(_SYSTEM_PROCCESS);
  endif;
?>