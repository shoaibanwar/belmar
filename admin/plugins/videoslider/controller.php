...
<?php
  ...
  if (isset($_POST['deleteSlide'])):
	...
	print ($db->affected()) ? $hollysec->writeLog(PLG_VS_SLIDE .' <strong>'.$title.'</strong> '._DELETED, "", "no", "plugin") . $core->msgOk(PLG_VS_SLIDE .' <strong>'.$title.'</strong> '._DELETED) : $core->msgAlert(_SYSTEM_PROCCESS);
  endif;
?>