...
<?php
  ...
  print ($db->affected()) ? $hollysec->writeLog(PLG_NS_ITEM .' <strong>'.$title.'</strong> '._DELETED, "", "no", "plugin") . $core->msgOk(PLG_NS_ITEM .' <strong>'.$title.'</strong> '._DELETED) : $core->msgAlert(_SYSTEM_PROCCESS);
  endif;
?>