<?php
  ...
  define("MODTHEMEDIR", ($content->moduledata['theme'] and is_file(HCODE."theme/".$content->moduledata['theme'].'/mod_index.php')) ? HCODE."theme/".$content->moduledata['theme'] : THEMEDIR);
